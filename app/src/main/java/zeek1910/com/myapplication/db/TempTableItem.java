...
public class TempTableItem implements Serializable {
    ...
    @Ignore
    public TempTableItem(String dayName, String owner, int lessonNumber, String lessonName, String lessonRoom, String lessonGroup) {
    ...
    @Ignore
    public TempTableItem(TempTableItem item){
